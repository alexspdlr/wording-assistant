    ...
    body: [
      {
        ...
        value: `Die DeepL API bietet programmatischen Zugriff auf die maschinelle Übersetzungstechnologie von DeepL und ermöglicht es, qualitativ hochwertige Übersetzungen direkt in Ihre Websites und Anwendungen einzubinden.
